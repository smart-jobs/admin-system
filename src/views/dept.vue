...
const { mapState, mapActions, mapMutations } = createNamespacedHelpers('system/dept');
...
export default {
  ...
  data() {
    return {
      ...
      form: {},
      rules: {
        name: [{ required: true, message: '请输入部门名称', trigger: 'blur' }, { min: 3, max: 20, message: '长度在 3 到 20 个字符', trigger: 'blur' }],
      },
      fields: [
