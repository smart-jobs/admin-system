...
const { mapState: _mapState, mapActions } = createNamespacedHelpers('system/tag');
...
export default {
  ...
  data() {
    return {
      ...
      tagFields: [{ name: 'tagid', label: 'ID', readonly: true }, { name: 'tagname', label: '标签', required: true }],
      operation: [['delete', '删除', 'el-icon-delete', true]] /* 操作类型 */,
      filter: undefined,
    };
  },
  computed: {
